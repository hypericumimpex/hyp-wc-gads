...
class WC_Integration extends \WC_Integration {
	...
	public function __construct( $init = true ) {
		...
		$this->method_title = __( 'Google Ads for WooCommerce', 'woocommerce-google-ads' );  // This is for the sub-section text.
	...
	public function init_form_fields() {
		$this->form_fields = [
			'account_id'   => [
				'title'   => __( 'Account Id', 'woocommerce-google-ads' ),
				'type'    => 'text',
				'default' => '',
			],
			'app_token'    => [
				'title'   => __( 'Application Token', 'woocommerce-google-ads' ),
				'type'    => 'text',
				'default' => '',
			],
			'google_token' => [
				'title'   => __( 'Google Verification Token', 'woocommerce-google-ads' ),
				'type'    => 'text',
				'default' => '',
			],
			'guide_link'   => [
				'type'        => 'desc',
				'description' => '<a href="https://support.sitewit.com/hc/en-us/articles/360016107933-WooCommerce-Advanced-Options" target="_blank" rel="noopener noreferrer">' . __( 'What are these options?', 'woocommerce-google-ads' ) . '</a>',
				'desc_tip'    => '',
			],
		];
	}
